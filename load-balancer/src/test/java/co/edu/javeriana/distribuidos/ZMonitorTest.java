...
public class ZMonitorTest {
    ...
    public void testZMonitor() throws IOException {
        ...
        final ZContext ctx = new ZContext();
        final Socket client = ctx.createSocket(SocketType.SUB);
        final Socket server = ctx.createSocket(SocketType.PUB);
        ...
        clientMonitor.start();
        // ZThread.fork(ctx, new Listener(), clientMonitor, "Client");
        ...
        serverMonitor.start();
        ZThread.fork(ctx, new Listener(), serverMonitor, "Server");
         ...
         * assertEquals(received.type, Event.CONNECTED);
         * 
    ...
    public void testZMonitorCurveOK() throws IOException {
        ...
        ctx.close();
        // [ZEvent [_PROTOCOL, code=32768, address=tcp://127.0.0.1:53682, value=3],
        // ZEvent [type=DISCONNECTED, code=512, address=tcp://127.0.0.1:53682,
        // value=null]]

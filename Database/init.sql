...
insert into Customers(username, password) values
    ('admin',  crypt('root', gen_salt('bf', 8))),
    ('user1', crypt('pass1', gen_salt('bf', 8))),
    ('user2', crypt('pass2', gen_salt('bf', 8)))
;
-- To retrieve:  SELECT * FROM Customers WHERE username='user2' AND password=crypt('pass2', password);
